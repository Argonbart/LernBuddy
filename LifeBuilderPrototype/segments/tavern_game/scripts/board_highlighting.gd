...
func set_field_to_no_highlight(field): # == 0
	field.add_theme_stylebox_override("panel", load("res://segments/tavern_game/gameboard_visual_styles/white_border.tres"))
...
func set_field_to_selected_highlight(field): # == 2
	field.add_theme_stylebox_override("panel", load("res://segments/tavern_game/gameboard_visual_styles/white_panel.tres"))
	field.set_material(shader)
